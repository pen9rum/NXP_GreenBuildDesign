...
#define BOARD_INITPINS_sensor_PERIPHERAL                                   GPIO1   /*!< Peripheral name */
#define BOARD_INITPINS_sensor_SIGNAL                                     gpio_io   /*!< Signal name */
#define BOARD_INITPINS_sensor_CHANNEL                                         3U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITPINS_sensor_GPIO                                         GPIO1   /*!< GPIO peripheral base pointer */
#define BOARD_INITPINS_sensor_GPIO_PIN                                        3U   /*!< GPIO pin number */
#define BOARD_INITPINS_sensor_GPIO_PIN_MASK                           (1U << 3U)   /*!< GPIO pin mask */
#define BOARD_INITPINS_sensor_PORT                                         GPIO1   /*!< PORT peripheral base pointer */
#define BOARD_INITPINS_sensor_PIN                                             3U   /*!< PORT pin number */
#define BOARD_INITPINS_sensor_PIN_MASK                                (1U << 3U)   /*!< PORT pin mask */
