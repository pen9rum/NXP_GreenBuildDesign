...
#define BOARD_INITPINS_AM2120senser_PERIPHERAL                             GPIO1   /*!< Peripheral name */
#define BOARD_INITPINS_AM2120senser_SIGNAL                               gpio_io   /*!< Signal name */
#define BOARD_INITPINS_AM2120senser_CHANNEL                                   3U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITPINS_AM2120senser_GPIO                                   GPIO1   /*!< GPIO peripheral base pointer */
#define BOARD_INITPINS_AM2120senser_GPIO_PIN                                  3U   /*!< GPIO pin number */
#define BOARD_INITPINS_AM2120senser_GPIO_PIN_MASK                     (1U << 3U)   /*!< GPIO pin mask */
#define BOARD_INITPINS_AM2120senser_PORT                                   GPIO1   /*!< PORT peripheral base pointer */
#define BOARD_INITPINS_AM2120senser_PIN                                       3U   /*!< PORT pin number */
#define BOARD_INITPINS_AM2120senser_PIN_MASK                          (1U << 3U)   /*!< PORT pin mask */
